...
public class ForgetPassServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        out.println(AccountDAO.INSTANCE.checkUsernameOrPhoneNumberExists(username, phonenumber));
        if (AccountDAO.INSTANCE.checkUsernameOrPhoneNumberExists(username, phonenumber) == true) {
            ...
            request.setAttribute("errorup", "Username or phonenumber not exist");
            request.getRequestDispatcher("Views/ForgetPass.jsp").forward(request, response);
        }
